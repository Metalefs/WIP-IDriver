...
<head>
    ...
    <div class="systemDevelopment">
        ...
        <button class="btn" type="button" onclick="window.location.href = 'criarModulo.php'">Criar Material de Estudo</button><br>
        <button class="btn" type="button" onclick="window.location.href = 'createExercise.php'">Criar exercício</button>
    </div>
    <?php
