...
/**/
    $query ="insert into exercise (creationDate,subject_subjectId,exerciseTitle,experienceProvided,admin_account_id,correctAnswer,description) values ('$time','$questionSubject','$questionTitle','$score','$author','$correctAnswer','$questionDescription');";
