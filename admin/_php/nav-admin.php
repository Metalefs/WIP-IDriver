        ...
        <nav id="bread-crumbs">
            ...
            <nav id="visual">
                ...
                <li  class="nav-item" id="user">
                    <img id="avatar" src="../avatars/<?php echo $_SESSION['adminAccount']['pictureId'] ?>.png" onerror="this.style.display='none'">
                    
                <h3 id="nav-username"><?php echo $_SESSION['userAccount']['userName'];?></h3><p id="arrow">></p>
                  </li>
