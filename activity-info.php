...
<main id="subject-in">
	...
	<div id="subject-info" class="sub-in">
        <div id="introduction"><a href="exercises.php?subjectId=2"><button id="start">Começar!</button></a>
            <h1 id="sub-name"><?php echo $subject->getSubjectName(); ?> -<?php echo $subject->getTotalExercises(); ?></h1>
            
            <h2 id="sub-description"><?php echo $subject->getDescription(); ?></h2>
        </div>
        <p id="sub-introduction"><?php echo $subject->getIntroduction(); ?></p>
...
<script>
            ...
            for (i = 0 ; i <= <?php echo $totalExercises ?> ; i++){
                getExercise(i);
            }
   // getExercise(i);
